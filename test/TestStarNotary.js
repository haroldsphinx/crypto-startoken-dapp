...
it('lets 2 users exchange stars', async() => {
    ...
    let user1 = accounts[1];
    let starId1 = 7;
    await instance.createStar("AdeStar", starId1, {from: user1})

    let user2 = accounts[2];
    let starId2 = 8

    await instance.createStar('AdeStar', starId2, {from: user2})
